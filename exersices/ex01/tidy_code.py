...
if __name__ == '__main__':
    ...
    while not result and tries > 0: #While result and tries are not bigger than 0
        guess = your_guess()
        result = check(random, guess) #Checks if your guess and random generated number is the same
    ...
    if tries > 0: #If you have tries left
        ...
        print('You lost. Correct answer: {}.'.format(random)) #Otherwise you lost. This was the randomly generated number